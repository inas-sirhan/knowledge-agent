...
- Name: smoke.spec.ts >> Knowledge Agent — end-to-end smoke >> Alice (pizza KB) can sign in, chat, and see citations
...
- complementary:
  ...
  - button "Sign out"
- main:
  - text: What style of pizza should I try if my home oven maxes at 550°F? Something went wrong. Try again.
