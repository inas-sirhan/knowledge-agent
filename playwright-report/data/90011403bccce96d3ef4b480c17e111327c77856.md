...
- Name: smoke.spec.ts >> Knowledge Agent — end-to-end smoke >> Off-topic question gets graceful refusal
- Location: e2e\smoke.spec.ts:142:7
...
- complementary:
  ...
  - navigation:
    ...
    - link "Admin":
      - /url: /admin
  - text: Signed in as alice@demo.local
  - button "Sign out"
- main:
  - text: How do I optimize a slow Postgres query?
  - link "[1] Diagnostics and troubleshooting — fix what went wrong":
    - /url: "#"
  - link "[2] Diagnostics and troubleshooting — fix what went wrong":
    - /url: "#"
  - link "[3] Canonical recipes — six complete pizzas you can actually make":
    - /url: "#"
  - link "[4] Grilled pizza and outdoor pizza ovens":
    - /url: "#"
  - link "[5] Grilled pizza and outdoor pizza ovens":
    - /url: "#"
  - link "[6] Pizza on a budget — great pies for not much money":
    - /url: "#"
  - link "[7] A topping-by-topping deep dive":
    - /url: "#"
  - link "[8] Dough fundamentals — the four ingredients and what they do":
    - /url: "#"
  - paragraph: I'm focused on pizza-related topics, so I can't assist with optimizing Postgres queries. However, if you have questions about pizza techniques, dough recipes, or troubleshooting pizza issues, feel free to ask!
  - link "[1] Diagnostics and troubleshooting — fix what went wrong":
    - /url: "#"
  - link "[2] Diagnostics and troubleshooting — fix what went wrong":
    - /url: "#"
